...
var FBify = function (c) {
    ...
    return function (req, res, next) {
        //console.log("req.facebook.accessToken", req.facebook.accessToken);
        console.log("req.query", req.query);
        console.log("FBify req.session", req.session.user_id);
        console.log("FBify req.accessToken", req.session.accessToken);
        ...
        if (req.query && req.query.accessToken) {
            ...
            req.facebook.setAccessToken(req.session.accessToken);
        }
