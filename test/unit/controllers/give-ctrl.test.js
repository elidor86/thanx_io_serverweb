describe('controllers', function() {
	...
	describe('GiveController', function() {
		...
		it('should send correct requests when using givebtc method', function() {
			...
			expect($rootScope.bitcoinSend).toHaveBeenCalledWith('bruce.thanx.io', 15000, 10000, 'hello and goodbye', undefined, jasmine.any(Function));
		...
		it('should send correct requests when using givemain method to send satoshi', function() {
			...
			expect($rootScope.bitcoinSend).toHaveBeenCalledWith('maya.thanx.io', 20000, 10000, 'hello', undefined, jasmine.any(Function));
			expect($rootScope.bitcoinSend.callCount).toBe(1);
