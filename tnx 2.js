...
function makeGiveRequest(giverProfile, getter, sat, tnx, msg, res, fb, req) {
...
m.mkRequest = FBify(function (profile, req, res) {
    ...
    if (requestType === constants.RequestTypes.GET) {
        ...
        return makeGetRequest(profile, from, sat, tnx, msg, res, fb, req);
    } else if (requestType === constants.RequestTypes.GIVE) {
        var to = req.param('giveTo');
        return makeGiveRequest(profile, to, sat, tnx, msg, res, fb, req);
    } else {
